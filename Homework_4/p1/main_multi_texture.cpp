...
int main(int argc, const char * argv[])
{
    ...
    int texid = texture->loadAndCreateTextures("../../data/textures/color_gradient.bmp", "../../data/textures/Universe.bmp","../../data/textures/doge.bmp");
    ...
    while(!glfwWindowShouldClose(window))
    {
		...
		bool ret = texture->setTextureBlendMode(0);// (g_change_texture_blend);
