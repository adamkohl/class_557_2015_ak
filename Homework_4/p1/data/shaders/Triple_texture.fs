...
uniform int g_change_texture_blend;
...
void main(void)                                                   
{
    ...
    if(g_change_texture_blend == 0)
    {
        //color = 0.5*pass_Color + tex_color;
		color = 0.1*pass_Color + 0.5*tex_color +  0.5*tex_color_light +  0.5*tex_color_extra;
    }
    else if(g_change_texture_blend == 1)
    {
        color = tex_color * tex_color_light * tex_color_extra;;
    }
    else if(g_change_texture_blend == 2)
    {
