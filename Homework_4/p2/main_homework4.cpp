...
int main(int argc, const char * argv[])
{
    ...
    GLAppearance* apperance_0 = new GLAppearance("../data/shaders/noise.vs", "../data/shaders/noise.fs");
    
    GLDirectLightSource  light_source;
    light_source._lightPos = glm::vec4(00.0,10.0,10.0, 0.0);
    ...
    spotlight_source._lightPos = glm::vec4(0.0,00.0,30.0, 1.0);
    spotlight_source._ambient_intensity = 0.2;
    spotlight_source._specular_intensity = 20.5;
    ...
    int texid = texture->loadAndCreateTextures("../data/textures/mountain.bmp", "../data/textures/bumpMap.bmp");
    ...
    GLPlane3D* plane_0 = new GLPlane3D(0.0, 0.0, 0.0, 75.0, 50.0);
