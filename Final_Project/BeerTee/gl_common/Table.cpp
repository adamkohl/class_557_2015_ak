...
GLTable::GLTable(float width, float height, float length,  int rows, int cols  ):
...
void GLTable::initVBO(void)
{
    ...
    make_Table(_center_x, _center_y, _center_z, _width,
              _height,  _rows, _cols,
 ...
 */
void GLTable::make_Table(float center_x, float center_y, float center_z, float width,
                        ...
                        vector<Vertex>& vp, vector<Vertex>& nv )
{
    ...
    //1st leg
    vp[24].x() = _width/2.0 + center_x-3;
    vp[24].y() = -_height/2.0 + center_y;
    vp[24].z() = -_length/2.0 + center_z;
    
    vp[25].x() = _width/2.0 + center_x;
    vp[25].y() = -_height/2.0 + center_y;
    vp[25].z() = -_length/2.0 + center_z;
    
    vp[26].x() = _width/2.0 + center_x-3;
    vp[26].y() = -_height/2.0 + center_y;
    vp[26].z() = -_length/2.0 + center_z-7;
    
    
    vp[27].x() = _width/2.0 + center_x;
    vp[27].y() = -_height/2.0 + center_y;
    vp[27].z() = -_length/2.0 + center_z-7;
