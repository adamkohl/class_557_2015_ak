...
void GLObjectObjFl::updatecenter(float xn, float yn, float zn)
{
    center[0] += xn;
    center[1] += yn;
    center[2] += zn;
...
bool GLObjectObjFl::extractNextFace1(string& in, string& out, int& pointIdx0, int& pointIdx1, int& pointIdx2 )
{
    GLuint a,b,c;
...
bool GLObjectObjFl::extractNextFace3(string& in, string& out, int& pointIdx, int& texIdx, int& normalIdx )
{
    GLuint a,b,c;
...
bool GLObjectObjFl::load_obj(const char* filename, vector<glm::vec3> &vertices, vector<glm::vec3> &normals, vector<GLuint> &elements)
{
 ...
 */
void GLObjectObjFl::initVBO(void)
{
 ...
 */
void GLObjectObjFl::initShader(void)
{
...
*/
void GLObjectObjFl::updateVertices(float* vertices)
{
